...
const NAV = [
  ...
  { section: 'Workflow', items: [
    { href: '/dashboard/approvals', label: 'Approval requests',         icon: 'check',  badge: true },
    { href: '/dashboard/history',   label: 'Approval History',  icon: 'clock'   },
    { href: '/dashboard/reports',   label: 'Reports',           icon: 'chart'   },
    { href: '/dashboard/blocklist', label: 'Block',         icon: 'shield'  },
    { href: '/dashboard/retrieve',  label: 'Retrieve',          icon: 'clock'   }, // ✅ NEW
  ]},
];
