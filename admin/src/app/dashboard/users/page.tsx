...
export default function UsersPage() {
  ...
  useEffect(() => {
    ...
    if (!token) return;
    // Use dedicated /admin/users endpoint — returns only approved users
    // whose sangha is also approved (server-side filtered, no client filtering needed)
