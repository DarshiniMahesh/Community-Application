...
// Edit user (sets profile to under_review)
router.put('/edit-user/:id',     requireRole('sangha', 'admin'), sc.editUserProfile);
...
// Admin only — /:id LAST to avoid swallowing other routes
