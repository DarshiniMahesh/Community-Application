...
-- ============================================================
-- TRIGGERS — auto overall_completion_pct
-- ============================================================
...
CREATE TRIGGER trg_sangha_profiles_updated BEFORE UPDATE ON sangha_profiles   FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_profiles_updated        BEFORE UPDATE ON profiles           FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_personal_updated        BEFORE UPDATE ON personal_details   FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_religious_updated       BEFORE UPDATE ON religious_details  FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_family_updated          BEFORE UPDATE ON family_info        FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_location_updated        BEFORE UPDATE ON addresses          FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_education_updated       BEFORE UPDATE ON member_education   FOR EACH ROW EXECUTE FUNCTION set_updated_at();
CREATE TRIGGER trg_economic_updated        BEFORE UPDATE ON economic_details   FOR EACH ROW EXECUTE FUNCTION set_updated_at();
